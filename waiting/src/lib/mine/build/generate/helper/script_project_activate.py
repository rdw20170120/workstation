...
def abort_if_activated():
    return [
        ...
        and_(),
        echo_fatal(
            "Project ", sq(vr("BO_Project")), " is already activated, aborting"
        ),
        and_(),
        exit(100),
        eol(),
...
def activate_for_linux():
    return [
        ...
        line(),
        source_script(
            dq(path(vr("BO_Home"), "helper", "activation", "activate.src"))
        ),
    ]
...
def comments():
    return [
        note(
            "We MUST NOT EVER 'exit' during BriteOnyx bootstrap or activation"
        ),
        rule(),
        debugging_comment(),
        ...
        comment(),
        note(
            "This script, and EVERY script that it calls, must NOT invoke 'exit'!  The user calling this"
        ),
        comment(
...
def capture_incoming_environment():
    return [
        ...
        if_(
            ...
            "  ",
            capture_environment(vr("TMPDIR"), "BO-env-incoming.out"),
            eol(),
        ),
        elif_(
            string_is_not_null(vr("BO_Project")),
            "  ",
            capture_environment(vr("BO_Project"), "BO-env-incoming.out"),
            eol(),
        ),
        else_(
            "  ",
            capture_environment(vr("PWD"), "BO-env-incoming.out"),
            eol(),
        ),
        fi(),
    ]
...
def capture_outgoing_environment():
    return [
        ...
        if_(
            string_is_not_null(vr("TMPDIR")),
            "  ",
            capture_environment(vr("TMPDIR"), "BO-env-outgoing.out"),
            eol(),
        ),
        elif_(
            string_is_not_null(vr("BO_Project")),
            "  ",
            capture_environment(vr("BO_Project"), "BO-env-outgoing.out"),
            eol(),
        ),
        else_(
            "  ",
            capture_environment(vr("PWD"), "BO-env-outgoing.out"),
            eol(),
        ),
        fi(),
    ]
...
def copy_starter_files():
    return [
        ...
        line(),
        assign(vn("DirSrc"), path(vr("BO_Project"), "BriteOnyx", "starter")),
        eol(),
        line(),
        require_variable(vn("HOME")),
        eol(),
        assign(vn("DirTgt"), vr("HOME")),
        eol(),
        ...
        eol(),
        line(),
        assign(vn("FileTgt"), path(vr("DirTgt"), ".BriteOnyx.src")),
        eol(),
        comment("Move previous scripts to new path"),
        file_exists(path(vr("DirTgt"), "BriteOnyx.src")),
        and_(),
        command("mv", path(vr("DirTgt"), "BriteOnyx.src"), vr("FileTgt")),
        eol(),
        file_exists(path(vr("DirTgt"), "BriteOnyx-env.bash")),
        and_(),
        command("mv", path(vr("DirTgt"), "BriteOnyx-env.bash"), vr("FileTgt")),
        eol(),
        file_exists(path(vr("DirTgt"), "BriteOnyx-env.src")),
        and_(),
        command("mv", path(vr("DirTgt"), "BriteOnyx-env.src"), vr("FileTgt")),
        eol(),
        comment("Copy starter script, if necessary"),
        path_is_not_file(vr("FileTgt")),
        and_(),
        command("cp", path(vr("DirSrc"), "user-BriteOnyx.src"), vr("FileTgt")),
        eol(),
        line(),
        assign(vn("DirTgt"), path(vr("BO_Project"))),
        eol(),
        path_does_not_exist(vr("DirTgt")),
        and_(),
        command("mkdir", "-p", vr("DirTgt")),
        eol(),
        line(),
        assign(vn("FileTgt"), path(vr("DirTgt"), "env.src")),
        eol(),
        path_is_not_file(vr("FileTgt")),
        and_(),
        command("cp", path(vr("DirSrc"), "project-env.src"), vr("FileTgt")),
        eol(),
        line(),
        assign(vn("FileTgt"), path(vr("DirTgt"), ".hgignore")),
        eol(),
        path_is_not_file(vr("FileTgt")),
        and_(),
        command("cp", path(vr("DirSrc"), "project.hgignore"), vr("FileTgt")),
        eol(),
        line(),
        assign(vn("DirTgt"), path(vr("BO_Project"), "bin")),
        eol(),
        path_does_not_exist(vr("DirTgt")),
        and_(),
        command("mkdir", "-p", vr("DirTgt")),
        ...
        line(),
        assign(
            vn("FileTgt"), path(vr("DirTgt"), "project-fix-permissions.bash")
        ),
        eol(),
        comment("Move previous scripts to new path"),
        ...
        and_(),
        command(
            "mv", path(vr("DirTgt"), "all-fix-permissions.bash"), vr("FileTgt")
        ),
        eol(),
        comment("Copy starter script, if necessary"),
        path_is_not_file(vr("FileTgt")),
        ...
        command(
            "cp",
            path(vr("DirSrc"), "project-fix-permissions.bash"),
            vr("FileTgt"),
        ),
        eol(),
        line(),
        line(": <<'DisabledContent'"),
        assign(vn("FileTgt"), path(vr("DirTgt"), "declare.src")),
        eol(),
        path_is_not_file(vr("FileTgt")),
        and_(),
        command(
            "cp", path(vr("DirSrc"), "project-declare.src"), vr("FileTgt")
        ),
        eol(),
        line(),
        assign(vn("FileTgt"), path(vr("DirTgt"), "development.rst")),
        eol(),
        path_is_not_file(vr("FileTgt")),
        and_(),
        command(
            "cp", path(vr("DirSrc"), "project-development.rst"), vr("FileTgt")
        ),
        eol(),
        line(),
        assign(vn("FileTgt"), path(vr("DirTgt"), "README.rst")),
        eol(),
        path_is_not_file(vr("FileTgt")),
        and_(),
        command("cp", path(vr("DirSrc"), "project-README.rst"), vr("FileTgt")),
        eol(),
        line(),
        assign(vn("DirTgt"), path(vr("BO_Project"), "bin", "helper", "Linux")),
        eol(),
        path_does_not_exist(vr("DirTgt")),
        and_(),
        command("mkdir", "-p", vr("DirTgt")),
...
def create_random_tmpdir():
    return [
        ...
        assign(
            vn("Dir"), substitute("mktemp", "--tmpdir", "-d", "BO-XXXXXXXX")
        ),
        eol(),
        directory_exists(vr("Dir")),
        and_(),
        export(vn("TMPDIR"), vr("Dir")),
        eol(),
    ]
...
def declare_for_bootstrap():
    return [
        ...
        assign(
            vn("Script"),
            dq(path(vr("BO_Project"), "BriteOnyx", "declare.src")),
        ),
        eol(),
        ...
        rule(),
        note(
            "Now that we have our support functionality declared, we can use it from here on"
        ),
    ]
...
def declare_for_project():
    return [
        ...
        line(),
        assign(vn("Script"), dq(path(vr("BO_Project"), "declare.src"))),
        eol(),
        if_(
...
def demonstrate_logging():
    return [
        ...
        line(),
        log_debug("EXAMPLE: This is a debugging message"),
        eol(),
        log_info("EXAMPLE: This is an informational message"),
        eol(),
        log_warn("EXAMPLE: This is a warning message"),
        eol(),
        log_error("EXAMPLE: This is an error message"),
        eol(),
        log_fatal('"EXAMPLE: This is a fatal message'),
        eol(),
    ]
...
def initialize_logging_file():
    return [
        ...
        assign(vn("BO_FileLog"), "BO.log"),
        eol(),
        if_(
            string_is_not_null(vr("TMPDIR")),
            "  ",
            export(vn("BO_FileLog"), path(vr("TMPDIR"), vr("BO_FileLog"))),
            eol(),
        ),
        elif_(
            string_is_not_null(vr("BO_Project")),
            "  ",
            export(vn("BO_FileLog"), path(vr("BO_Project"), vr("BO_FileLog"))),
            eol(),
        ),
        else_(
            "  ",
            export(vn("BO_FileLog"), path(vr("PWD"), vr("BO_FileLog"))),
            eol(),
        ),
        fi(),
        echo_info("Activating..."),
        " >",
        vr("BO_FileLog"),
        eol(),
        echo_info("Activating the BriteOnyx framework for this project..."),
        eol(),
        echo_warn(
            "This script MUST be executed as 'source activate.src', WAS IT?"
        ),
        eol(),
    ]
...
def normalize_reference_to_project_root():
    return [
        ...
        return_last_status(),
        eol(),
        trace_variable(sq(vn("BO_Project"))),
        eol(),
        export(
            vn("BO_Project"),
            dq(substitute("boNodeCanonical", vr("BO_Project"))),
        ),
        eol(),
        trace_variable(sq(vn("BO_Project"))),
        eol(),
...
def remember_project_root():
    return [
        ...
        line(),
        export(vn("BO_Project"), dq(substitute("dirname", vr("BASH_SOURCE")))),
        eol(),
        line(),
        todo(
            "REVIEW: Shall we NOT cd into our project directory since it changes"
        ),
        comment("the caller's execution environment?"),
        comment(
            command("cd", dq(path(vr("BO_Project")))),
            or_(),
            return_last_status(),
        ),
    ]
...
def set_tmpdir():
    return [
        ...
        line(),
        comment(
            export(vn("TMPDIR"), path(vr("TMPDIR"), vr("BO_ProjectName")))
        ),
        comment(

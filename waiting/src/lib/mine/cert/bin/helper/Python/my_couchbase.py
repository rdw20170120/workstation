...
def service_name(service_identifier):
    result = None
    if service_identifier == SERVICE_DATA_ID:
        result = SERVICE_DATA_NAME
    elif service_identifier == SERVICE_INDEX_ID:
        result = SERVICE_INDEX_NAME
    elif service_identifier == SERVICE_QUERY_ID:
        result = SERVICE_QUERY_NAME
    elif service_identifier == SERVICE_SEARCH_ID:
        result = SERVICE_SEARCH_NAME
    else:
        raise UnrecognizedValueError(
            service_identifier,
            type(service_identifier),
            "Couchbase service identifier",
        )

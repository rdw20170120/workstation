...
alias jump_elixir='cd ~/repo/GitHub/wip/bookish-system'
alias jump_email='cd ~/repo/GitHub/wip/email'
...
[[ -z "${BO_DirReference}" ]] && export BO_DirReference=~/repo/GitHub/ref/x20241204
[[ -z "${BO_DirWorkInProgress}" ]] && export BO_DirWorkInProgress=~/repo/GitHub/wip/x20241204

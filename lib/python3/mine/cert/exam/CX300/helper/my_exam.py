...
PSI_DURATION_BREAKDOWN = 40*60
PSI_DURATION_EXAM = 4*60
PSI_DURATION_GRACE = 15
PSI_DURATION_SETUP = 4*60

# NOTE: Dev/Test - move as needed for deployed environment, last one executed wins
environment = ENV_DEV
environment = ENV_TEST
PSI_DURATION_BREAKDOWN = 2*60
PSI_DURATION_EXAM = 1*60
PSI_DURATION_GRACE = 5
PSI_DURATION_SETUP = 1*60

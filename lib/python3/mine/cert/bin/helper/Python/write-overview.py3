...
understand the exam and the machines that constitute the exam environment.  You ''',
    ...
    page.add(htmltags.ul(css_class)[
        htmltags.li[link(css_class, PAGE_MACHINE, 'machine naming conventions')],
        htmltags.li[link(css_class, PAGE_SSH, 'HowTo:  access other exam machines')],
        htmltags.li[link(css_class, PAGE_SUDO, 'HowTo:  gain superuser privileges')],
        htmltags.li[link(css_class, PAGE_DOC_4_6, 'Documentation for Couchbase Server 4.6')],
    ])
...
take this exam.''',
    ...
    page.add(htmltags.ul[
        htmltags.li[link(css_class, PAGE_UI, 'HowTo:  understand the exam user interface (UI)')],
        htmltags.li[link(css_class, PAGE_SESSION, 'HowTo:  begin/end your exam session')],

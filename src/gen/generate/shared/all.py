...
def _generate_briteonyx(dir_):
    ...
    briteonyx(executed(), sub, "anaconda-capture")
    briteonyx(executed(), sub, "anaconda-check")
    briteonyx(executed(), sub, "anaconda-create")
    briteonyx(executed(), sub, "anaconda-destroy")
    briteonyx(executed(), sub, "anaconda-populate")
    briteonyx(executed(), sub, "anaconda-report")
    briteonyx(executed(), sub, "anaconda-upgrade")
    ...
    briteonyx(executed(), sub, "py-format")

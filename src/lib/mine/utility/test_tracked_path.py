...
def test_tracked_path():
    ...
    assert is_.equal(repr(b), "TrackedPath('Test', PosixPath('/123'), PosixPath('abc'))")
    ...
    assert is_.equal(repr(d), "TrackedPath('Test', PosixPath('/123'), PosixPath('abc/xyz'))")
    ...
    assert is_.equal(repr(e), "TrackedPath('Test', PosixPath('/123'), PosixPath('abc/xyz/def.ghi'))")
    ...
    assert is_.equal(repr(f), "TrackedPath('Test', PosixPath('/123'), PosixPath('abc'))")
    ...
    assert is_.equal(repr(g), "TrackedPath('Test', PosixPath('/123'), PosixPath('abc'))")
    ...
    assert is_.equal(repr(h), "TrackedPath('Test', PosixPath('/123'), PosixPath('abc'))")

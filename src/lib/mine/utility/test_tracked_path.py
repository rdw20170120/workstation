...
def test_tracked_path():
    ...
    assert is_.absolute_path(a.top)
    assert is_.equal(a.top, a)
    assert is_.relative_path(a.subpath)
    ...
    assert is_.absolute_path(b.top)
    assert is_.equal(b.top, a)
    assert is_.relative_path(b.subpath)
    ...
    assert is_.absolute_path(d.top)
    assert is_.equal(d.top, a)
    assert is_.relative_path(d.subpath)
    ...
    assert is_.absolute_path(e.top)
    assert is_.equal(e.top, a)
    assert is_.relative_path(e.subpath)
    ...
    assert is_.absolute_path(f.top)
    assert is_.equal(f.top, a)
    assert is_.relative_path(f.subpath)
    ...
    assert is_.absolute_path(g.top)
    assert is_.equal(g.top, a)
    assert is_.relative_path(g.subpath)
    ...
    assert is_.absolute_path(h.top)
    assert is_.equal(h.top, a)
    assert is_.relative_path(h.subpath)

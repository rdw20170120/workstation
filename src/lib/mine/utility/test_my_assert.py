...
def test_is_instance():
    ...
    a = str(info.value)
    assert "<class 'NoneType'>" in a, 'TODO: message'
    assert "<class 'str'>" in a, 'TODO: message'
